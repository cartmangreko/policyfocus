...
NEW = {
 ...
 "GST-158": {
   "class": "admitted",
   "leg": "carbon capture at works",
   "leg_before_20_september": "announced DRI plant",
   "leg_corrected_why": "THE CENSUS READ THE WRONG LEG AND THE PERIMETER HAD THE WRONG NUMBER OF LEGS. The Innovation Fund factsheet describes carbon capture, utilisation and storage at Ravenna, not a direct reduction plant, and on 20 September the steel perimeter gained a fifth leg: capture on the emissions of an iron- or steelmaking works, on the same footing as capture at a cement works, which is the rule of 24 August applied to the one sector where it had not been written down. The entry stays in steel with route `carbon capture at works`, the funder admission standing and the owner leg open. sources/steel_docket.md, D-S13.",
   "admitted_by": "funder",
