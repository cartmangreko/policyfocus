...
export const metadata: Metadata = {
  title: "Sectors",
  description:
    "Every sector the register maps, with the burden/benefit, status and channel summary for each — parents first, children nested under the parent that files them.",
};
